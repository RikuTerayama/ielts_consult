  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <p>
          当サイトでは、お問い合わせページのフォーム（Netlify Forms）を通じて、お名前・メールアドレス・お問い合わせ内容を受信しています。これらの情報は、お問い合わせへの返信および業務上の連絡の目的でのみ利用し、当サイト運営者が管理するNetlifyのサーバーに一時保管されます。第三者への提供は行いません。フォーム送信後、いただいた情報は適切に管理し、必要に応じて削除いたします。
        </p>
