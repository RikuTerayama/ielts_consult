    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <p>
          ...
          筆者の実体験、学習方法の提案、外部の公開情報を区別して紹介します。
          例文や練習プランは、実測データや受講者の実績を示すものではありません。
        </p>
        ...
        <h2>更新方針</h2>
        <p>
          試験条件や説明の見直しなど、本文に意味のある変更を行った場合は記事の冒頭に更新日を明記します。
          公開日は元の記録を維持し、サイトの再ビルドや共通デザインの変更だけでは記事の更新日を変更しません。
        </p>
        ...
        <p>
          IELTSの形式・採点基準はIELTS、British Council、IDPなどの公式情報を優先します。
          教材の仕様は出版社の情報を確認し、筆者が提案する勉強時間や復習順序を公式ルールとして扱いません。
          個人の成果や感想には条件や個人差があります。<Link href="/affiliate-disclosure/">広告・アフィリエイトの開示</Link>もご確認ください。
        </p>
